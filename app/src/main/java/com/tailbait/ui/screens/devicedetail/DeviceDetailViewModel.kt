...
class DeviceDetailViewModel
    ...
    constructor(
        ...
        data class DeviceDetail(
            ...
            val address: String,
            val name: String,
            // Local name from BLE advertisement
        ...
        fun loadDeviceDetail(deviceId: Long) {
            viewModelScope.launch {
                try {
                    ...
                    val locationWithDetections =
                        locations.map { location ->
                            LocationWithDetection(
                                locationId = location.id,
                                // Location entity doesn't have a name field
                                name = null,
                                latitude = location.latitude,
                                longitude = location.longitude,
                                timestamp = location.timestamp,
                                // Would need to calculate from detection records
                                detectionCount = 1,
                    ...
                    val canPlaySound =
                        trackerSoundManager.isTrackerWithSoundSupport(
        ...
        private fun calculateDetectionStats(
            ...
            val averageDetectionsPerDay =
                if (trackingPeriodDays > 0) {
            ...
            return DetectionStats(
                ...
                // Would need detailed detection records
                mostActiveDay = "",
                // Would need detailed detection records
                peakDetectionHour = 0,
