...
class DetectionWorkerTest {
    ...
    @Test
    fun testDetectionWorker_successWithDetections() =
        runBlocking {
    ...
    @Test
    fun testDetectionWorker_successWithNoDetections() =
        runBlocking {
    ...
    @Test
    fun testDetectionWorker_retryOnError() =
        runBlocking {
    ...
    @Test
    fun testDetectionWorker_customInputParameters() =
        runBlocking {
    ...
    @Test
    fun testDetectionWorker_alertGenerationWithThrottling() =
        runBlocking {
            // Given
            val detectionResults =
                listOf(
