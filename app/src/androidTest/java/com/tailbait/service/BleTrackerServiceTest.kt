...
class TailBaitServiceTest {
    ...
    fun tearDown() =
        runBlocking {
            ...
            try {
                ...
                val stopIntent =
                    Intent(context, TailBaitService::class.java).apply {
     ...
     */
    @Test
    fun testServiceStartStickyBehavior() =
        runTest {
            val startIntent =
                Intent(context, TailBaitService::class.java).apply {
                    action = Constants.ACTION_START_TRACKING
     ...
     */
    @Test
    fun testBleScannerManagerIntegration() =
        runTest {
            val startIntent =
                Intent(context, TailBaitService::class.java).apply {
                    action = Constants.ACTION_START_TRACKING
