...
class CorrelationIntegrationTest {
     ...
     */
    @Test
    fun testBasicDeviceLocationCorrelation() =
        runTest {
     ...
     */
    @Test
    fun testDeviceUpsertUpdatesExistingDevice() =
        runTest {
     ...
     */
    @Test
    fun testDeviceSeenAtMultipleLocations() =
        runTest {
     ...
     */
    @Test
    fun testLocationChangeDetection() =
        runTest {
            // Given - Two locations
            val location1 =
                Location(
     ...
     */
    @Test
    fun testSignificantLocationChange() =
        runTest {
     ...
     */
    @Test
    fun testBatchCorrelationRecordInsertion() =
        runTest {
    ...
    fun testTimeWindowMatching() =
        runTest {
            ...
            val recordsInWindow =
                deviceLocationRecordDao.getRecordsByTimeRange(
                    timeWindowStart,
                    timeWindowEnd,
                ).first()
     ...
     */
    @Test
    fun testDuplicateRecordPrevention() =
        runTest {
            // Given - Location and device
            ...
            val records =
                deviceLocationRecordDao.getRecordsForDeviceAtLocation(
                    deviceId,
                    locationId,
                ).first()
     ...
     */
    @Test
    fun testScanTriggerTypeTracking() =
        runTest {
            // Given - Location and device
            val locationId =
                locationDao.insert(
            ...
            val manualRecords =
                deviceLocationRecordDao.getRecordsByScanType(
                    Constants.SCAN_TRIGGER_MANUAL,
                ).first()
            assertEquals(1, manualRecords.size)

            val continuousRecords =
                deviceLocationRecordDao.getRecordsByScanType(
    ...
    fun testSuspiciousDeviceQuery() =
        runTest {
            ...
            val suspiciousDevices =
                deviceRepository.getSuspiciousDevices(
                    minLocationCount = 3,
                ).first()
     ...
     */
    @Test
    fun testLocationBasedRecordFiltering() =
        runTest {
