...
class LearnModeFlowTest {
    ...
    @Test
    fun completeLearnModeFlow_discoversAndAddsDevices() =
        runTest {
            ...
            assertTrue(
                "Entries should be marked as Learn Mode additions",
    ...
    @Test
    fun learnModeFlow_doesNotAddDuplicateDevices() =
        runTest {
            ...
            assertTrue(
                "Device should already be whitelisted",
    ...
    @Test
    fun learnModeFlow_filtersDevicesByTimeRange() =
        runTest {
    ...
    @Test
    fun learnModeFlow_handlesEmptySelection() =
        runTest {
            // Step 1: Start Learn Mode
            settingsRepository.startLearnMode()
    ...
    @Test
    fun learnModeFlow_categorizesDifferentDeviceTypes() =
        runTest {
            // Start Learn Mode
            settingsRepository.startLearnMode()
            val settings = settingsRepository.getSettings().first()
    ...
    @Test
    fun learnModeFlow_preservesDeviceLabels() =
        runTest {
            // Start Learn Mode
            settingsRepository.startLearnMode()
            val settings = settingsRepository.getSettings().first()
