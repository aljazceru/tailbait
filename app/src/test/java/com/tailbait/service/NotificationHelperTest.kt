...
class NotificationHelperTest {
    ...
    @Test
    fun `showAlertNotification should show notification when settings allow`() =
        runTest {
            // Given
    ...
    @Test
    fun `showAlertNotification should not show when notifications disabled in settings`() =
        runTest {
            // Given
    ...
    @Test
    fun `showAlertNotification should handle different alert levels correctly`() =
        runTest {
            // Given
            val criticalAlert =
                sampleAlert.copy(
    ...
    @Test
    fun `showAlertNotification should use low priority channel for low alerts`() =
        runTest {
            // Given
    ...
    @Test
    fun `showAlertNotification should use high priority channel for high alerts`() =
        runTest {
            // Given
    ...
    @Test
    fun `dismissNotification should cancel notification and mark alert dismissed`() =
        runTest {
            // Given
    ...
    @Test
    fun `dismissNotification should update summary notification`() =
        runTest {
            // Given
            every { notificationManagerCompat.cancel(any()) } just Runs
            every { notificationManagerCompat.notify(any(), any()) } just Runs
    ...
    @Test
    fun `showSummaryNotification should show when multiple active alerts exist`() =
        runTest {
            // Given
            val alerts =
                listOf(
    ...
    @Test
    fun `notification should not show sound when sound disabled in settings`() =
        runTest {
            // Given
    ...
    @Test
    fun `notification should not vibrate when vibration disabled in settings`() =
        runTest {
            // Given
    ...
    @Test
    fun `hasNotificationPermission should return true on Android 12 and below`() =
        runTest {
            // Given
    ...
    @Test
    fun `showTestNotification should show test notification when permission granted`() =
        runTest {
            // Given
            every { notificationManagerCompat.areNotificationsEnabled() } returns true
            every { notificationManagerCompat.notify(any(), any()) } just Runs
    ...
    @Test
    fun `showTestNotification should not show when permission not granted`() =
        runTest {
            // Given
    ...
    @Test
    fun `notification should include all three actions for alerts with devices`() =
        runTest {
            // Given
            val alertWithDevices =
                sampleAlert.copy(
    ...
    @Test
    fun `critical alert should use maximum priority`() =
        runTest {
            // Given
            val criticalAlert =
                sampleAlert.copy(
    ...
    @Test
    fun `low alert should use low priority`() =
        runTest {
            // Given
            val lowAlert =
                sampleAlert.copy(
    ...
    @Test
    fun `notification should be grouped correctly`() =
        runTest {
            // Given
            every { notificationManagerCompat.notify(any(), any()) } just Runs
    ...
    @Test
    fun `exception during notification should be handled gracefully`() =
        runTest {
            // Given
    ...
    @Test
    fun `summary notification should cancel when no active alerts remain`() =
        runTest {
            // Given
            every { notificationManagerCompat.cancel(any()) } just Runs
            coEvery { alertRepository.dismissAlert(any()) } returns true
    ...
    @Test
    fun `summary notification should cancel when only one active alert remains`() =
        runTest {
            // Given
