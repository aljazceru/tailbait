...
class LocationRepositoryTest {
    ...
    @Test
    fun `insertLocation should insert location and return ID`() =
        runTest {
            // Given
            val expectedId = 123L
    ...
    @Test
    fun `insertLocation should handle locations without altitude`() =
        runTest {
            // Given
    ...
    @Test
    fun `getLastLocation should return most recent location`() =
        runTest {
            // Given
    ...
    @Test
    fun `getLastLocation should return null when no locations exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `getAllLocations should return empty list when no locations exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `getLocationsForDevice should return device-specific locations`() =
        runTest {
            // Given
            val deviceId = 42L
    ...
    @Test
    fun `getLocationsForDevice should return empty list when device has no locations`() =
        runTest {
            // Given
            val deviceId = 999L
    ...
    @Test
    fun `deleteOldLocations should delete locations before timestamp`() =
        runTest {
            // Given
    ...
    @Test
    fun `deleteOldLocations should return 0 when no old locations exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `deleteOldLocations should handle large timestamp values`() =
        runTest {
            // Given
    ...
    @Test
    fun `insertLocation should handle location with very high accuracy value`() =
        runTest {
            // Given
    ...
    @Test
    fun `insertLocation should handle location with negative altitude`() =
        runTest {
    ...
    @Test
    fun `insertLocation should handle extreme coordinates`() =
        runTest {
    ...
    @Test
    fun `getAllLocations should handle very large location lists`() =
        runTest {
            // Given
            val largeLocationList =
                List(1000) { index ->
                    testLocation1.copy(
                        id = index.toLong(),
    ...
    @Test
    fun `getLocationsForDevice should handle non-existent device ID`() =
        runTest {
            // Given
    ...
    @Test
    fun `locations should maintain chronological order`() =
        runTest {
            // Given
    ...
    @Test
    fun `findOrCreateLocation should reuse location from more than 24h ago`() =
        runTest {
    ...
    @Test
    fun `findOrCreateLocation should create new location when none nearby`() =
        runTest {
            // Given
            val now = System.currentTimeMillis()
    ...
    @Test
    fun `location providers should be preserved`() =
        runTest {
            // Given
