...
class AlertViewModelTest {
    ...
    @Test
    fun `loads active and dismissed alerts successfully`() =
        runTest {
    ...
    @Test
    fun `active alerts are not dismissed`() =
        runTest {
            viewModel = createAndSubscribe()
            testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `dismissed alerts are marked as dismissed`() =
        runTest {
            viewModel = createAndSubscribe()
            testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `alerts are sorted correctly`() =
        runTest {
            viewModel = createAndSubscribe()
            testDispatcher.scheduler.advanceUntilIdle()
